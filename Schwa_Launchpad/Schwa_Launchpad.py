# Embedded file name: /Users/versonator/Jenkins/live/output/mac_64_static/Release/python-bundle/MIDI Remote Scripts/Schwa_Launchpad/Schwa_Launchpad.py
...
class Schwa_Launchpad(ControlSurface):
    u""" Script for Novation's Schwa_Launchpad Controller """
    ...
    def __init__(self, c_instance):
        ...
        with self.component_guard():
            ...
            is_momentary = True
            self._suggested_input_port = 'Schwa_Launchpad'
            self._suggested_output_port = 'Schwa_Launchpad'
